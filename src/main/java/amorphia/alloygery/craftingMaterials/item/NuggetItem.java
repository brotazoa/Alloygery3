...
public class NuggetItem extends Item implements CraftingMaterialModelProvider.IItemModelGen
{
    private final CraftingMaterial craftingMaterial;

    public NuggetItem(Properties properties, CraftingMaterial craftingMaterial)
    {
        super(properties);
    ...
    {
        ResourceLocation texture = Alloygery.asResource("template/crafting_material/" + craftingMaterial.getVariantType().getName() + "_nugget_template_" + craftingMaterial.getName());
