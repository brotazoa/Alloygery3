...
public class IngotItem extends Item implements CraftingMaterialModelProvider.IItemModelGen
{
    private final CraftingMaterial craftingMaterial;

    public IngotItem(Properties properties, CraftingMaterial craftingMaterial)
    {
        super(properties);
    ...
    {
        ResourceLocation texture = Alloygery.asResource("template/crafting_material/" + craftingMaterial.getVariantType().getName() + "_ingot_template_" + craftingMaterial.getName());
