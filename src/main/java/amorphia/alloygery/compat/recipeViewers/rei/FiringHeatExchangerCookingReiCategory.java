...
public class FiringHeatExchangerCookingReiCategory extends HeatExchangerCookingReiCategory
{
	public static final Component TITLE = Component.translatable("category.rei.alloygery.heat_exchanger_firing");
	public static final EntryStack<ItemStack> ICON = EntryStacks.of(MachinesModule.KILN_WITH_HEAT_EXCHANGER);
	...
	public void drawFurnaceBlockState(GuiGraphics graphics, int x, int y)
	{
		RecipeViewerCommonBlockStateRenderers.drawHeatExchangerWithBlock(
				graphics, x, y, MachinesModule.KILN_WITH_HEAT_EXCHANGER.defaultBlockState()
	...
	{
		return AlloygeryReiPlugin.HEAT_EXCHANGER_FIRING;
	}
