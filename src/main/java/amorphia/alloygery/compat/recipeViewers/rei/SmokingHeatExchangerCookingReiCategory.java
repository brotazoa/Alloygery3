...
public class SmokingHeatExchangerCookingReiCategory extends HeatExchangerCookingReiCategory
{
	public static final Component TITLE = Component.translatable("category.rei.alloygery.heat_exchanger_smoking");
	public static final EntryStack<ItemStack> ICON = EntryStacks.of(MachinesModule.SMOKER_WITH_HEAT_EXCHANGER);
	...
	public void drawFurnaceBlockState(GuiGraphics graphics, int x, int y)
	{
		RecipeViewerCommonBlockStateRenderers.drawHeatExchangerWithBlock(
				graphics, x, y, MachinesModule.SMOKER_WITH_HEAT_EXCHANGER.defaultBlockState()
	...
	{
		return AlloygeryReiPlugin.HEAT_EXCHANGER_SMOKING;
	}
