...
import amorphia.alloygery.machines.alloyKiln.AlloyKilnBlock;
...
public class SimpleAlloyingEmiRecipe implements EmiRecipe
{
	...
	SimpleAlloyingEmiRecipe(SimpleAlloyingRecipe recipe)
	{
		...
		this.time = recipe.getSmeltingTime();
	...
	{
		return AlloygeryEmiPlugin.SIMPLE_ALLOYING;
	}
	...
	public void addWidgets(WidgetHolder widgets)
	{
		...
		widgets.addDrawable(49, 30, 24, 24, new BlockRenderWidget(MachinesModule.ALLOY_KILN.defaultBlockState().setValue(AlloyKilnBlock.FACING, Direction.SOUTH).setValue(AlloyKilnBlock.LIT, true)));
