...
public record HeatExchangerWithBlockRenderWidget(BlockState blockState) implements EmiRenderable, DrawableWidget.DrawableWidgetConsumer
{
	@Override
	public void render(GuiGraphics draw, int x, int y, float delta)
	{
		RecipeViewerCommonBlockStateRenderers.drawHeatExchangerWithBlock(draw, 0, 0, blockState);
